                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-12" style="margin : 0 auto">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="needs-validation" novalidate method="POST" action="http://localhost:8000/admin/categories/update/{{$category->id}}">
                                        @csrf
                                        <div class="mb-1">
                                            <label class="form-label fs-5 fw-bolder" for="basic-addon-name">Tên Danh mục</label>
                                            <input type="text" name="category_name" id="basic-addon-name" class="form-control" value="{{$category->category_name}}" placeholder="Nhập tên Danh mục" aria-label="Name" aria-describedby="basic-addon-name" required />
