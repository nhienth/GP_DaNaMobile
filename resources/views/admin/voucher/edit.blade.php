                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Form -->
                                    <form action="{{route('updateVoucher')}}" class="mt-2">
                                        <div class="row">
                                            <div class="form-group">
                                                <label>Danh Mục</label>
                                                <select class="form-control" name="vouchers_id" id="exampleSelectGender">
                                                    @foreach ($allvouChers as $vouChers)
                                                        <option value="{{$vouChers->id}}">{{$vouChers->Vouchers_ma}}</option>
                                                    @endforeach
                                                  </select>
                                            </div>
