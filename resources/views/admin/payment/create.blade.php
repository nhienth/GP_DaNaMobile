                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="http://127.0.0.1:8000/admin/product/list">Phương thức thanh toán</a>
                                </li>
                            ...
                            <div class="card-body">
                                <form class="needs-validation" novalidate action="{{url('/admin/payment/create')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="text" id="basic-addon-name" class="form-control" placeholder="Nhập phương thức thanh toán" aria-label="Name" name="payment_name" aria-describedby="basic-addon-name" required />
                                    </div>

                                    <div class="mb-1">
                                        <label class="form-label fs-5 fw-bolder" for="basic-addon-name">Ghi chú</label>

                                        <input type="text" id="basic-addon-name" class="form-control" placeholder="Nhập ghi chú" aria-label="Name" name="payment_status" aria-describedby="basic-addon-name" required />
                                    </div>
