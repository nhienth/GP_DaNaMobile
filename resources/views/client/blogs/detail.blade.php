                    ...
                    <div class="col-xl-9 col-wd">
                        <div class="min-width-1100-wd">
                            <article class="card mb-8 border-0">
                                <div class="card-body pt-5 pb-0 px-0">
                                    <div class="d-block d-md-flex flex-center-between mb-4 mb-md-0">
                                        <h2 class="mb-md-3 mb-1 text-black">{{$findPost->title}}</h2>
                                        <a href="#" class="font-size-12 text-gray-5 ml-md-4"><i class="far fa-comment"></i> Để lại bình luận</a>
                                    </div>
                                    <div class="mb-3 pb-3 border-bottom">
                                        <div class="list-group list-group-horizontal flex-wrap list-group-borderless align-items-center mx-n0dot5">
                                            <a href="http://localhost:8000/post/details/{{$findPost->id}}" class="mx-0dot5 text-gray-5">{{$findPost->category->category_name}}</a>
                                                  
                                            <span class="mx-2 font-size-n5 mt-1 text-gray-5"><i class="fas fa-circle"></i></span>
                                            <a href="http://localhost:8000/post/details/{{$findPost->id}}" class="mx-0dot5 text-gray-5">{{$findPost->created_at->format('d/m/Y')}}</a>
                                        </div>
                                    </div>                              
                                    <div class="row">
                                        <?php                                           
                                            echo $findPost->content;    
                                        ?>                                        
                                    </div>
                                </div>
                            </article>
                            <div class="bg-gray-1 px-3 py-5 mb-10">
                                ...
                                <div class="d-block d-md-flex media">
                                    <div class="u-xl-avatar mb-4 mb-md-0 mr-md-4">
                                        <img class="img-fluid" src="{{asset('/images/post/' . $findPost->post_img)}}" alt="Image Description">
                                    </div>
                                    <div class="media-body">
                                        <h3 class="font-size-18 mb-3"><a href="../blog/single-blog-post.html">{{$findPost->title}}</a></h3>
                                        <p class="mb-0">{{$findPost->summary}}</p>
                                    </div>
                                </div>
                                <!-- End Review -->
                            </div>
                            ...
                            <div class="mb-10">
                                ...
                                <form class="js-validate" action="{{route('post_review',$findPost->id)}}"  method="POST" novalidate="novalidate">
                                    @csrf
                                    @if (Auth::check())
