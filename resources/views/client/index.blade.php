                    ...
                    <div class="js-slide bg-img-hero-center">
                        <div class="row min-height-420 py-7 py-md-0">
                            ...
                            <div class="col-xl-5 col-6  d-flex align-items-center"
                                ...
                                <img class="img-fluid" src="{{asset('images/products/'.$products->product_img)}}" width="265px" alt="Image Description">
                            </div>
                        </div>
                    </div>
                    @endforeach
                        ...
                        <a href="../shop/shop.html" class="d-black text-gray-90">
                            <div class="min-height-132 py-1 d-flex bg-gray-1 align-items-center">
                                <div class="col-6 col-xl-5 col-wd-6 pr-0">
                                    <img class="img-fluid" src="{{asset('images/category/'.$list->category_image)}}" alt="Image Description">
                                </div>
                                        ...
                                        <div class="product-item__outer h-100">
                                            <div class="product-item__inner px-xl-4 p-3">
                                                <div class="product-item__body pb-xl-2">
                                                    ...
                                                    <div class="mb-2">
                                                        <a href="../shop/single-product-fullwidth.html" class="d-block text-center"><img class="img-fluid" src="{{asset('images/products/'.$productsss->product_img)}}" alt="Image Description"></a>
                                                    </div>
