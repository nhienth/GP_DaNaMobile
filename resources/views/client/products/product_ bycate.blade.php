                    ...
                    <ul class="list-unstyled">
                            ...
                            <div class="row">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75">
                                        <img class="img-fluid" src="{{asset('client/assets/img/300X300/img1.jpg"')}} alt="Image Description">
                                    </a>
                                </div>
                                <div class="col">
                        ...
                        <li class="mb-4">
                            <div class="row">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75">
                                        <img class="img-fluid" src="{{asset('client/assets/img/300X300')}}img6.jpg" alt="Image Description">
                                    </a>
                                </div>
                                <div class="col">
                        ...
                        <li class="mb-4">
                            <div class="row">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75">
                                        <img class="img-fluid" src="{{asset('client/assets/img/300X300')}}img10.png" alt="Image Description">
                                    </a>
                                </div>
                                <div class="col">
                        ...
                        <div class="product-item__outer h-100 w-100">
                            <div class="product-item__inner px-xl-4 p-3">
                                <div class="product-item__body pb-xl-2">
                                    <div class="mb-2">
                                        <a href="#" class="d-block text-center"><img class="img-fluid" src="{{asset('client/assets/img/300X300')}}img8.jpg" alt="Image Description"></a>
                                    </div>
                    ...
                    <li class="col-6 col-md-3 product-item">
                        <div class="product-item__outer h-100 w-100">
                            <div class="product-item__inner px-xl-4 p-3">
                                <div class="product-item__body pb-xl-2">
                                    <div class="mb-2">
                                        <a href="#" class="d-block text-center"><img class="img-fluid" src="{{asset('client/assets/img/300X300')}}img15.jpg" alt="Image Description"></a>
                                    </div>
                    ...
                    <li class="col-6 col-md-3 product-item">
                        <div class="product-item__outer h-100 w-100">
                            <div class="product-item__inner px-xl-4 p-3">
                                <div class="product-item__body pb-xl-2">
                                    <div class="mb-2">
                                        <a href="#" class="d-block text-center"><img class="img-fluid" src="{{asset('client/assets/img/300X300')}}img22.jpg" alt="Image Description"></a>
                                    </div>
                    ...
                    <li class="col-6 col-md-3 product-item remove-divider">
                        <div class="product-item__outer h-100 w-100">
                            <div class="product-item__inner px-xl-4 p-3">
                                <div class="product-item__body pb-xl-2">
                                    <div class="mb-2">
                                        <a href="#" class="d-block text-center"><img class="img-fluid" src="{{asset('client/assets/img/300X300')}}img23.jpg" alt="Image Description"></a>
                                    </div>
                    ...
                    <li class="col-6 col-md-3 product-item">
                        <div class="product-item__outer h-100 w-100">
                            <div class="product-item__inner px-xl-4 p-3">
                                <div class="product-item__body pb-xl-2">
                                    <div class="mb-2">
                                        <a href="#" class="d-block text-center"><img class="img-fluid" src="{{asset('client/assets/img/300X300')}}img24.jpg" alt="Image Description"></a>
                                    </div>
                    ...
                    <li class="col-6 col-md-3 product-item">
                        <div class="product-item__outer h-100 w-100">
                            <div class="product-item__inner px-xl-4 p-3">
                                <div class="product-item__body pb-xl-2">
                                    <div class="mb-2">
                                        <a href="#" class="d-block text-center"><img class="img-fluid" src="{{asset('client/assets/img/300X300')}}img25.jpg" alt="Image Description"></a>
                                    </div>
                    ...
                    <li class="col-6 col-md-3 product-item">
                        <div class="product-item__outer h-100 w-100">
                            <div class="product-item__inner px-xl-4 p-3">
                                <div class="product-item__body pb-xl-2">
                                    <div class="mb-2">
                                        <a href="#" class="d-block text-center"><img class="img-fluid" src="{{asset('client/assets/img/300X300')}}img5.jpg" alt="Image Description"></a>
                                    </div>
                    ...
                    <li class="col-6 col-md-3 product-item remove-divider">
                        <div class="product-item__outer h-100 w-100">
                            <div class="product-item__inner px-xl-4 p-3">
                                <div class="product-item__body pb-xl-2">
                                    <div class="mb-2">
                                        <a href="#" class="d-block text-center"><img class="img-fluid" src="{{asset('client/assets/img/300X300')}}img26.jpg" alt="Image Description"></a>
                                    </div>
